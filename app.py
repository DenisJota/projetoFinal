...
class App:
    ...
    def atualizarTabela(self):
        ...
        for aluno in alunos:
            self.tabela.insert('', END, values=(aluno['matricula'], aluno['nome'], aluno['idade'], aluno['curso'],
                                                aluno['nota']))
    ...
    def adicionarAluno(self):
        ...
        self.limparCampos()
        self.atualizarTabela()
        messagebox.showinfo("Sucesso!", "Aluno foi adicionado com sucesso!")
    ...
    def editarAluno(self):
        ...
        self.limparCampos()
        self.atualizarTabela()
        messagebox.showinfo("Sucesso!", "Aluno foi editado com sucesso!")

    def deletarAluno(self):
        matricula = self.txt_matricula.get()
        self.db.delect(matricula)
        self.limparCampos()
        self.atualizarTabela()
        messagebox.showinfo("Sucesso!", "Aluno foi deletado com sucesso!")
